...
function UsersTab() {
    ...
    return (
        <>
                                            ...
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                {currentUser?.id !== teamUser.id && teamUser.role !== 'primary_admin' ? (
                                                    <>
                                                        ...
                                                        >
                                                            {deactivatingId === teamUser.id ? <Loader2 size={15} className="animate-spin" /> : <X size={15} />}
                                                        </button>
                                                        <button
                                                            onClick={() => setDeleteConfirmUserId(teamUser.id)}
            ...
            {deleteConfirmUserId && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div className="fixed inset-0 bg-black/40" onClick={() => setDeleteConfirmUserId(null)} />
                    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-red-100 flex items-center justify-center">
                                <Trash2 className="w-5 h-5 text-red-600" />
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">Delete User Permanently</h3>
                                <p className="text-sm text-red-500 font-medium">This cannot be undone.</p>
                            </div>
                        </div>
                        <p className="text-sm text-gray-600">
                            This will permanently remove the user and all their data from the system. This action is irreversible.
                        </p>
                        <div className="flex gap-3 pt-1">
                            <button
